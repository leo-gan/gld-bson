...
from schema.model import SK_ARRAY, SK_BOOL, SK_F64, SK_I32, SK_I64, SK_REF, SK_STRING, Field, SchemaDoc, TypeDef
...
def _emit_type(td: TypeDef) -> String:
    ...
    while r < len(td.fields):
        ...
        r += 1
    s += "\n"
    s += "from runtime.datum import BsonDatum\n"
    s += "from runtime.error import DecodeError\n"
    s += "from wire.reader import WireReader\n"
    s += "from wire.types import TY_BOOL, TY_DOCUMENT, TY_DOUBLE, TY_INT32, TY_INT64, TY_STRING\n"
    s += "from wire.writer import WireWriter, digit_count\n\n"
